Public Class Form1
    ...
    Private Sub Buttoncompute_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Buttoncompute.Click
        ...
        If response = DialogResult.Yes Then
            ...
            If TextBox7.Text >= 98 Then
                TextBox6.Text = "1.00"
                TextBox5.Text = "passed"
            ElseIf TextBox7.Text >= 95 Then
                TextBox6.Text = "1.25"
                TextBox5.Text = "passed"
            ElseIf TextBox7.Text >= 92 Then
                TextBox6.Text = "1.50"
                TextBox5.Text = "passed"
            ElseIf TextBox7.Text >= 89 Then
                TextBox6.Text = "1.75"
                TextBox5.Text = "passed"
            ElseIf TextBox7.Text >= 86 Then
                TextBox6.Text = "2.00"
                TextBox5.Text = "passed"
            ElseIf TextBox7.Text >= 83 Then
                TextBox6.Text = "2.25"
                TextBox5.Text = "passed"
            ElseIf TextBox7.Text = 80 Then
                TextBox6.Text = "2.50"
                TextBox5.Text = "passed"
            ElseIf TextBox7.Text = 77 Then
                TextBox6.Text = "2.75"
                TextBox5.Text = "passed"
            ElseIf TextBox7.Text >= 75 Then
                TextBox6.Text = "3.00"
                TextBox5.Text = "passed"
            ElseIf TextBox7.Text >= 71 Then
                TextBox6.Text = "4.0"
                TextBox5.Text = "INC"
